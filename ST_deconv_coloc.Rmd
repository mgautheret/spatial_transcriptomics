...
CTest=SPADE(
  ...
  sign_list=markers,
  loc=location,
  ctData=CTperLayer) # the estimated cell type per domain # Offset is the value add on the threshold to binarize coefficient from lasso regression, if not provide by user, then use the mean of all coefficients
```
